...
class Obydullah_Restaurant_Sales_Terminal_Sales
{
    /**
    ...
    public function opfw_render_page()
    {
        ...
        <div class="wrap">
            <h1 class="wp-heading-inline mb-3">
                <?php esc_html_e('Sales Management', 'obydullah-restaurant-sales-terminal'); ?>
            </h1>
                ...
                <div class="col-lg-12">
                    <div class="bg-light p-4 rounded shadow-sm border">
                        <h2 class="h5 mb-3 fw-semibold">
                            <?php esc_html_e('Sales History', 'obydullah-restaurant-sales-terminal'); ?>
                        </h2>
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                <div class="search-group flex-grow-1">
                                    <label for="search-invoice" class="form-label mb-1">
                                        <?php esc_html_e('Search Invoice', 'obydullah-restaurant-sales-terminal'); ?>
                                    </label>
                                    <input type="text" id="search-invoice"
                                        class="form-control form-control-sm"
                                        placeholder="<?php esc_attr_e('Invoice number...', 'obydullah-restaurant-sales-terminal'); ?>">
                                    <div class="form-text">
                                        <?php esc_html_e('Search by invoice number', 'obydullah-restaurant-sales-terminal'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-md-3">
                                <label for="date-from" class="form-label small mb-1">
                                    <?php esc_html_e('Date From', 'obydullah-restaurant-sales-terminal'); ?>
                                </label>
                                <input type="date" id="date-from" class="form-control form-control-sm">
                            </div>
                            <div class="col-md-3">
                                <label for="date-to" class="form-label small mb-1">
                                    <?php esc_html_e('Date To', 'obydullah-restaurant-sales-terminal'); ?>
                                </label>
                                <input type="date" id="date-to" class="form-control form-control-sm">
                            </div>
                            <div class="col-md-3">
                                <label for="sale-type" class="form-label small mb-1">
                                    <?php esc_html_e('Sale Type', 'obydullah-restaurant-sales-terminal'); ?>
                                </label>
                                <select id="sale-type" class="form-control form-control-sm">
                                    <option value=""><?php esc_html_e('All Types', 'obydullah-restaurant-sales-terminal'); ?></option>
                                    <option value="dineIn"><?php esc_html_e('Dine In', 'obydullah-restaurant-sales-terminal'); ?></option>
                                    <option value="takeAway"><?php esc_html_e('Take Away', 'obydullah-restaurant-sales-terminal'); ?></option>
                                    <option value="pickup"><?php esc_html_e('Pick Up', 'obydullah-restaurant-sales-terminal'); ?></option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <label for="sale-status" class="form-label small mb-1">
                                    <?php esc_html_e('Sale Status', 'obydullah-restaurant-sales-terminal'); ?>
                                </label>
                                <select id="sale-status" class="form-control form-control-sm">
                                    ...
                                    <option value="completed"><?php esc_html_e('Completed', 'obydullah-restaurant-sales-terminal'); ?></option>
                                    <option value="pending"><?php esc_html_e('Pending', 'obydullah-restaurant-sales-terminal'); ?></option>
                                    <option value="cancelled"><?php esc_html_e('Cancelled', 'obydullah-restaurant-sales-terminal'); ?></option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center gap-2">
                                    <button type="button" id="search-sales" class="btn btn-primary btn-sm">
                                        <span class="btn-text"><?php esc_html_e('Search', 'obydullah-restaurant-sales-terminal'); ?></span>
                            ...
                            <table class="table table-striped table-hover table-bordered mb-2">
                                <thead>
                                    <tr class="bg-primary text-white">
                                        <th width="120"><?php esc_html_e('Invoice ID', 'obydullah-restaurant-sales-terminal'); ?></th>
                                        <th width="100"><?php esc_html_e('Date', 'obydullah-restaurant-sales-terminal'); ?></th>
                                        <th><?php esc_html_e('Customer', 'obydullah-restaurant-sales-terminal'); ?></th>
                                        <th width="100"><?php esc_html_e('Type', 'obydullah-restaurant-sales-terminal'); ?></th>
                                        <th width="120"><?php esc_html_e('Total', 'obydullah-restaurant-sales-terminal'); ?></th>
                                        <th width="100"><?php esc_html_e('Status', 'obydullah-restaurant-sales-terminal'); ?></th>
                                        <th width="150" class="text-right"><?php esc_html_e('Actions', 'obydullah-restaurant-sales-terminal'); ?></th>
                                    </tr>
                                </thead>
                                <tbody id="sales-list" class="bg-white">
                                    <tr>
                                        <td colspan="7" class="text-center p-4">
                                            ...
                                            <?php esc_html_e('Loading sales...', 'obydullah-restaurant-sales-terminal'); ?>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center mt-2">
                            <div class="tablenav-pages">
                                ...
                                <span class="pagination-links ms-2">
                                    <a class="first-page btn btn-sm btn-dark" href="#" title="<?php esc_attr_e('First page', 'obydullah-restaurant-sales-terminal'); ?>">&laquo;</a>
                                    <a class="prev-page btn btn-sm btn-dark" href="#" title="<?php esc_attr_e('Previous page', 'obydullah-restaurant-sales-terminal'); ?>">&lsaquo;</a>
                                    ...
                                    <a class="next-page btn btn-sm btn-dark" href="#" title="<?php esc_attr_e('Next page', 'obydullah-restaurant-sales-terminal'); ?>">&rsaquo;</a>
                                    <a class="last-page btn btn-sm btn-dark" href="#" title="<?php esc_attr_e('Last page', 'obydullah-restaurant-sales-terminal'); ?>">&raquo;</a>
                                </span>
                            </div>
                            <div class="tablenav-pages">
    ...
    public function opfw_ajax_get_opfw_sales()
    {
        ...
        $all_sales = Obydullah_Restaurant_Sales_Terminal_Helpers::opfw_cache_get_or_set($cache_key, function () use ($search, $sale_type, $args) {
            $count_args        = $args;
            $count_args['limit'] = -1;
            $count_args['page']  = 1;
            ...
            foreach ($all_orders as $order) {
                ...
                if (empty($customer_name)) {
                    $customer_name = __('Walk-in Customer', 'obydullah-restaurant-sales-terminal');
                }
    ...
    public function opfw_ajax_print_opfw_sale()
    {
        ...
        if (!$sale_id) {
            wp_send_json_error(__('Invalid sale ID', 'obydullah-restaurant-sales-terminal'));
        }

        $order = wc_get_order($sale_id);
        if (!$order) {
            wp_send_json_error(__('Sale not found', 'obydullah-restaurant-sales-terminal'));
        }
        ...
        wp_send_json_success([
            ...
            'items'           => $items,
            'shop_info'       => Obydullah_Restaurant_Sales_Terminal_Helpers::opfw_get_shop_info(),
        ]);
    }
    ...
    public function opfw_ajax_delete_opfw_sale()
    {
        ...
        wp_send_json_success(__('Sale deleted successfully', 'obydullah-restaurant-sales-terminal'));
    }
}
