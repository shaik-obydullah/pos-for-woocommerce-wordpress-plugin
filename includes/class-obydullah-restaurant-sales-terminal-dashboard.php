...
class Obydullah_Restaurant_Sales_Terminal_Dashboard
{
    /**
    ...
    {
        return Obydullah_Restaurant_Sales_Terminal_Helpers::opfw_cache_get_or_set('stock_value', function () {
            $total = 0;
    ...
    {
        return Obydullah_Restaurant_Sales_Terminal_Helpers::opfw_cache_get_or_set('today_sales', function () {
    ...
    {
        return Obydullah_Restaurant_Sales_Terminal_Helpers::opfw_cache_get_or_set('month_sales', function () {
    ...
    {
        return Obydullah_Restaurant_Sales_Terminal_Helpers::opfw_cache_get_or_set('today_income', function () {
            $total = 0;
            $orders = wc_get_orders([
                'date_created' => current_time('Y-m-d'),
                'status'       => 'completed',
    ...
    {
        return Obydullah_Restaurant_Sales_Terminal_Helpers::opfw_cache_get_or_set('month_income', function () {
            $first_day = current_time('Y-m-01');
            $last_day  = current_time('Y-m-t');
            $total = 0;
    ...
    {
        return Obydullah_Restaurant_Sales_Terminal_Helpers::opfw_cache_get_or_set('low_stock_count', function () {
            $count = 0;
            $products = wc_get_products([
                'limit'  => -1,
                'status' => 'publish',
    ...
    public function opfw_render_page()
    {
        ...
        ?>
<div class="wrap">
    <h1 class="wp-heading-inline mb-3"><?php esc_html_e('Restaurant POS Dashboard', 'obydullah-restaurant-sales-terminal'); ?></h1>
    <hr class="wp-header-end">

    <div class="row mb-4">
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-info">
                <h3 class="fs-6 fw-normal text-muted mb-2"><?php esc_html_e('Low Stock Items', 'obydullah-restaurant-sales-terminal'); ?></h3>
                <p class="summary-number text-info mb-0 fs-3 fw-bold"><?php echo esc_html($dashboard_data['low_stock_count']); ?></p>
                <small class="text-muted mb-3"><?php esc_html_e('Items with low stock', 'obydullah-restaurant-sales-terminal'); ?></small>
            </div>
        </div>

        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-info">
                <h3 class="fs-6 fw-normal text-muted mb-2"><?php esc_html_e('Stock Value', 'obydullah-restaurant-sales-terminal'); ?></h3>
                ...
                <small class="text-muted mb-3"><?php esc_html_e('Current inventory value', 'obydullah-restaurant-sales-terminal'); ?></small>
            </div>
        </div>

        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-success">
                <h3 class="fs-6 fw-normal text-muted mb-2"><?php esc_html_e("Today's Sales", 'obydullah-restaurant-sales-terminal'); ?></h3>
                ...
                <small class="text-muted mb-3"><?php esc_html_e('Completed orders today', 'obydullah-restaurant-sales-terminal'); ?></small>
            </div>
        </div>

        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-primary">
                <h3 class="fs-6 fw-normal text-muted mb-2"><?php esc_html_e('Monthly Sales', 'obydullah-restaurant-sales-terminal'); ?></h3>
                ...
                <small class="text-muted mb-3"><?php esc_html_e('Total orders this month', 'obydullah-restaurant-sales-terminal'); ?></small>
            </div>
        </div>

        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-lime">
                <h3 class="fs-6 fw-normal text-muted mb-2"><?php esc_html_e("Today's Income", 'obydullah-restaurant-sales-terminal'); ?></h3>
                ...
                <small class="text-muted mb-3"><?php esc_html_e('Revenue generated today', 'obydullah-restaurant-sales-terminal'); ?></small>
            </div>
        </div>

        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-success">
                <h3 class="fs-6 fw-normal text-muted mb-2"><?php esc_html_e('Monthly Income', 'obydullah-restaurant-sales-terminal'); ?></h3>
                ...
                <small class="text-muted mb-3"><?php esc_html_e('Total revenue this month', 'obydullah-restaurant-sales-terminal'); ?></small>
            </div>
        </div>

        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-warning">
                <h3 class="fs-6 fw-normal text-muted mb-2"><?php esc_html_e("Today's Expense", 'obydullah-restaurant-sales-terminal'); ?></h3>
                ...
                <small class="text-muted mb-3"><?php esc_html_e('Expenses incurred today', 'obydullah-restaurant-sales-terminal'); ?></small>
            </div>
        </div>

        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-danger">
                <h3 class="fs-6 fw-normal text-muted mb-2"><?php esc_html_e('Monthly Expense', 'obydullah-restaurant-sales-terminal'); ?></h3>
                ...
                <small class="text-muted mb-3"><?php esc_html_e('Total expenses this month', 'obydullah-restaurant-sales-terminal'); ?></small>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="bg-light p-4 rounded shadow-sm">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h3 class="fs-6 fw-semibold mb-0"><?php esc_html_e('Top Selling Products', 'obydullah-restaurant-sales-terminal'); ?></h3>
                </div>
                    ...
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr class="bg-primary text-white">
                                <th class="ps-4"><?php esc_html_e('Product', 'obydullah-restaurant-sales-terminal'); ?></th>
                                <th class="text-center"><?php esc_html_e('Orders', 'obydullah-restaurant-sales-terminal'); ?></th>
                                <th class="text-center"><?php esc_html_e('Qty Sold', 'obydullah-restaurant-sales-terminal'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="text-center py-5">
                    <div class="py-4">
                        ...
                        <p class="mb-0 text-muted"><?php esc_html_e('No sales data available.', 'obydullah-restaurant-sales-terminal'); ?></p>
                    </div>
                </div>
                <?php endif; ?>
            </div>
