...
class Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Woo_Stock
{
    /**
...
<div class="wrap opfw-stocks-page">
    <h1 class="wp-heading-inline mb-3">
        <?php esc_html_e('Stock Management', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>
    </h1>
    ...
    <div class="row mb-4">
        <div class="col-sm-6 col-lg-3 mb-3">
            <div class="stock-summary-card text-center">
                <h3 class="text-muted"><?php esc_html_e('In Stock', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></h3>
                <p id="in-stock-count" class="summary-number text-primary">0</p>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3 mb-3">
            <div class="stock-summary-card text-center">
                <h3 class="text-muted"><?php esc_html_e('Out of Stock', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></h3>
                <p id="out-stock-count" class="summary-number text-danger">0</p>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3 mb-3">
            <div class="stock-summary-card text-center">
                <h3 class="text-muted"><?php esc_html_e('Low Stock', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></h3>
                <p id="low-stock-count" class="summary-number text-warning">0</p>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3 mb-3">
            <div class="stock-summary-card text-center">
                <h3 class="text-muted"><?php esc_html_e('Total Products', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></h3>
    ...
    <div class="row mt-3">
        <div class="col-lg-4">
            <div class="bg-light p-4 rounded shadow-sm">
                <h2 class="mb-3 mt-1"><?php esc_html_e('Update Stock', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></h2>
                <form id="update-stock-form" method="post">
                    ...
                    <div class="mb-3">
                        <label for="stock-product-input" class="form-label d-block mb-1">
                            <?php esc_html_e('Product', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?> <span class="text-danger">*</span>
                        </label>
                        <div id="stock-product-input-wrap" class="position-relative">
                            ...
                            <input type="text" id="stock-product-input" class="form-control" autocomplete="off"
                                placeholder="<?php esc_attr_e('Search and select a product...', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="buy-price" class="form-label d-block mb-1">
                                <?php esc_html_e('Buy Price', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>
                        ...
                        <div class="col-md-6">
                            <label for="sale-price" class="form-label d-block mb-1">
                                <?php esc_html_e('Sale Price', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>
                                <span class="text-danger">*</span>
                            </label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="stock-quantity" class="form-label d-block mb-1">
                                <?php esc_html_e('Quantity', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?> <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="col-md-6">
                            <label for="stock-status" class="form-label d-block mb-1">
                                <?php esc_html_e('Stock Status', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>
                            </label>
                            <select name="stock_status" id="stock-status" class="form-control">
                                <option value="instock"><?php esc_html_e('In Stock', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></option>
                                <option value="outofstock"><?php esc_html_e('Out of Stock', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></option>
                                <option value="onbackorder"><?php esc_html_e('On Backorder', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-3 border rounded mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="font-weight-bold"><?php esc_html_e('Profit Margin:', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></span>
                            <span id="profit-margin" class="profit-value font-weight-bold">0.00%</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="font-weight-bold"><?php esc_html_e('Total Profit:', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></span>
                    ...
                    <div class="d-flex mt-4">
                        <button type="submit" id="submit-stock" class="btn-primary mr-2">
                            <span class="btn-text"><?php esc_html_e('Update Stock', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></span>
        ...
        <div class="col-lg-8">
            <div class="bg-light p-3 rounded shadow-sm border">
                <h2 class="h5 mb-3 fw-semibold"><?php esc_html_e('Stock Overview', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></h2>
                        ...
                        <div class="search-group flex-grow-1">
                            <div class="position-relative flex-grow-1">
                                <input type="text" id="stock-search" class="form-control form-control-sm"
                                    placeholder="<?php esc_attr_e('Search products...', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>">
                            </div>
                        </div>
                        <div>
                    ...
                    <table class="table table-striped table-hover table-bordered mb-2">
                        <thead>
                            <tr class="bg-primary text-white">
                                <th><?php esc_html_e('Product', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th width="100"><?php esc_html_e('Buy Price', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th width="100"><?php esc_html_e('Sale Price', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th width="100"><?php esc_html_e('Quantity', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                        ...
                        <tbody id="stock-list" class="bg-white">
                            <tr>
                                <td colspan="5" class="text-center p-4">
                                    ...
                                    <?php esc_html_e('Loading...', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<div class="wrap">
    <h1 class="wp-heading-inline mb-4">
        <?php esc_html_e('Stock Adjustments', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>
    </h1>
    <hr class="wp-header-end">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="bg-light p-4 rounded shadow-sm mb-4">
                <h2 class="h4 mb-3 mt-1"><?php esc_html_e('New Stock Adjustment', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></h2>
                <form id="add-adjustment-form" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="product_id" id="adjustment-product" class="form-control" required>
                            <option value=""><?php esc_html_e('Select Product', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></option>
                        </select>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="adjustment-type" class="form-label fw-semibold">
                                <?php esc_html_e('Type', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?> <span class="text-danger">*</span>
                            </label>
                            <select name="adjustment_type" id="adjustment-type" class="form-control" required>
                                <option value="increase"><?php esc_html_e('Increase', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></option>
                                <option value="decrease"><?php esc_html_e('Decrease', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></option>
                            </select>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="alert alert-light border mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="text-dark"><?php esc_html_e('Current Stock:', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></span>
                            <span id="current-stock" class="fw-bold text-dark ml-1">0</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="text-dark"><?php esc_html_e('Adjustment:', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></span>
                            <span id="adjustment-display" class="fw-bold text-success ml-1">+0</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-dark"><?php esc_html_e('New Stock:', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></span>
                    ...
                    <div class="form-group mb-3">
                        <label for="adjustment-note" class="form-label fw-semibold">
                            <?php esc_html_e('Note', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>
                        </label>
                        <textarea name="note" id="adjustment-note" rows="3" class="form-control"
                            placeholder="<?php esc_attr_e('Reason for adjustment...', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?>"></textarea>
                    </div>

                    <div class="mt-4">
                        <button type="submit" id="submit-adjustment" class="btn btn-primary w-100">
                            <span class="btn-text"><?php esc_html_e('Apply Adjustment', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></span>
                            <span class="spinner opfw-hidden"></span>
                        </button>
                    </div>
                </form>
        ...
        <div class="col-md-8">
            <div class="bg-light p-3 rounded shadow-sm border">
                <h2 class="h5 mb-3 fw-semibold"><?php esc_html_e('Adjustments History', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></h2>

                <div class="table-responsive">
                    <table class="table table-striped table-hover table-bordered mb-2">
                        <thead>
                            <tr class="bg-primary text-white">
                                <th><?php esc_html_e('Date', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th><?php esc_html_e('Product', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th><?php esc_html_e('Type', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th><?php esc_html_e('Quantity', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th><?php esc_html_e('Old Qty', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th><?php esc_html_e('New Qty', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th><?php esc_html_e('Note', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                                <th class="text-right"><?php esc_html_e('Actions', 'obydullah-restaurant-sales-terminal-for-woocommerce'); ?></th>
                            </tr>
                        </thead>
...
<?php
    ...
    public function opfw_ajax_get_products_for_stocks()
    {
        ...
        $formatted = Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Helpers::opfw_cache_get_or_set('products_all', function () {
    ...
    public function opfw_ajax_get_stocks()
    {
        ...
        $response = Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Helpers::opfw_cache_get_or_set($cache_key, function () use ($page, $per_page, $search, $status_filter) {
    ...
    public function opfw_ajax_update_stock()
    {
        ...
        if ($quantity < 0) {
            wp_send_json_error(__('Quantity cannot be negative', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
        }

        if ($buy_price < 0 || $sale_price < 0) {
            wp_send_json_error(__('Prices cannot be negative', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
        }

        if ($product_id <= 0) {
            wp_send_json_error(__('Invalid product', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
        }
        ...
        if ($quantity !== $old_quantity) {
            $this->opfw_log_adjustment($product_id, $quantity > $old_quantity ? 'increase' : 'decrease',
                abs($quantity - $old_quantity), $old_quantity, $quantity, __('Stock update', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
        }

        Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Helpers::opfw_cache_flush_group('opfw_stocks');
        Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Helpers::opfw_cache_flush_group('opfw_adjustments');
        ...
        wp_send_json_success(__('Stock updated successfully', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
    }
    ...
    public function opfw_ajax_get_products_for_adjustments()
    {
        ...
        $formatted = Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Helpers::opfw_cache_get_or_set('products_for_adjustments', function () {
            $products = wc_get_products([
                'status' => 'publish',
                'limit' => -1,
                'return' => 'objects',
    ...
    public function opfw_ajax_get_current_stock()
    {
        ...
        $quantity = Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Helpers::opfw_cache_get_or_set($cache_key, function () use ($product_id) {
            $product = wc_get_product($product_id);
    ...
    public function opfw_ajax_add_adjustment()
    {
        ...
        if ($product_id <= 0) {
            wp_send_json_error(__('Please select a valid product', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
        }
        if ($quantity <= 0) {
            wp_send_json_error(__('Quantity must be greater than 0', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
        }
        ...
        if ($adjustment_type === 'decrease' && $quantity > $old_quantity) {
            wp_send_json_error(sprintf(
                ...
                __('Cannot decrease more than current stock. Available: %d', 'obydullah-restaurant-sales-terminal-for-woocommerce'),
                $old_quantity
            ));
        }
        ...
        wp_send_json_success(__('Stock adjustment applied successfully', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
    }
    ...
    public function opfw_ajax_get_adjustments()
    {
        ...
        Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Helpers::opfw_cache_register($cache_key, self::ADJUSTMENTS_CACHE_GROUP);
    ...
    public function opfw_ajax_delete_adjustment()
    {
        ...
        if (!$id) {
            wp_send_json_error(__('Invalid adjustment ID', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
        }
        ...
        if ($result === false) {
            wp_send_json_error(__('Failed to delete adjustment', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
        }

        Obydullah_Restaurant_Sales_Terminal_For_WooCommerce_Helpers::opfw_cache_flush_group('opfw_adjustments');

        wp_send_json_success(__('Adjustment deleted successfully', 'obydullah-restaurant-sales-terminal-for-woocommerce'));
    }
