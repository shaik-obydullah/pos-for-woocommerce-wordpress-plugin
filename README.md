# Obydullah Restaurant Sales Terminal for WooCommerce
...
**Obydullah Restaurant Sales Terminal for WooCommerce** is a complete restaurant management solution that helps you streamline your restaurant operations. Manage your menu, process orders, track inventory, handle customers, and generate sales reports — all from your WordPress admin area.
...
2. Search for "Obydullah Restaurant Sales Terminal for WooCommerce"
3. Click **Install Now**
4. Click **Activate**
...
1. After activation, go to **OBY Restaurant Sales Terminal** in your WordPress admin menu
2. Start by configuring your shop settings in **OBY Restaurant Sales Terminal → Settings**
3. Add your product categories in **OBY Restaurant Sales Terminal → Categories**
4. Add your menu items in **OBY Restaurant Sales Terminal → Products**
5. Set up your initial stock in **OBY Restaurant Sales Terminal → Stocks**
6. You're ready to start taking orders in **OBY Restaurant Sales Terminal → POS**

## Frequently Asked Questions

### How do I add menu items?

Go to **OBY Restaurant Sales Terminal → Products** in your WordPress admin to add menu items and organize them by categories.
...
Go to **OBY Restaurant Sales Terminal → Settings** to configure tax rates, VAT rates, currency, and other shop settings. You can enable/disable these features as needed.
...
Go to **OBY Restaurant Sales Terminal → Dashboard** for an overview of today's and monthly sales, income, expenses, and profits. The Sales section provides detailed transaction history.
...
Yes, the plugin is fully translation-ready and includes .pot file for translators. Text domain: `obydullah-restaurant-sales-terminal`.
